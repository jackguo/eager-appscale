...
class RemoteAuthorizationManagerClient {
    ...
    public RemoteAuthorizationManagerClient() throws APIManagementException {
        ...
        try {
            ConfigurationContext cfgCtx = ServiceReferenceHolder.getContextService().getClientConfigContext();
            authorizationManager = new RemoteAuthorizationManagerServiceStub(cfgCtx, serviceURL +
                    "RemoteAuthorizationManagerService");
            userStoreManager = new RemoteUserStoreManagerServiceStub(cfgCtx, serviceURL +
